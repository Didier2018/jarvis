	//     Pluguin J.A.R.V.I.S
	// créé à partir du plugin Sudo de Ted Kent et Jarvis de David.M

	// le Pluguin fonction de la façon suivante :
    // dans les commandes du XML il y a la condition : out.action.val=" "
    // la valeure qui est entre les guillmets correspond à la valeur
    // qui devra correspondre au case
    // dans le JS les Txt[0] correspondent aux réponses alléatoires
    // modifier les a vonlonté pour simuler une ia et surtout 
    // casser la routine des réponses de sarah

    // pour les raccourcis vers les fichiers .bat 
    // il vous faut modifier les fichiers .bat du dossier bin
    // en renseignant les raccourcis de vos logiciels ou dossiers.
...
switch(data.val) {
	...
	case "videos":
	  var process = '%CD%/plugins/jarvis/bin/film.bat';
	  var Txt = new Array; 
			Txt[0] = "C'est comme si c'était fai. Bon film.";
			Txt[1] = "Je m'en occupe. Je vous souète un bon film.";
			Txt[2] = "Voilà meussieu. Bon film a vous.";
			Txt[3] = "Dossier film ouvert. Bon film meussieu.";
	  break;
	...
	case "runshutdown":
	  ...
	  case "runsublimtext":
      var process = '%CD%/plugins/jarvis/bin/runsublimtext.bat';
	  var Txt = new Array; 
			Txt[0] = "j'ouvre l'editeur";
			Txt[1] = "je lance notpade";
			Txt[2] = "tout de suite";
	  break;
	  case "closesublimtext":
      var process = '%CD%/plugins/jarvis/bin/closesublimtext.bat';
	  var Txt = new Array; 
	  ...
	  //navigation navigateur internet 
	  ...
	  case "playlist":
	  process = '%CD%/plugins/jarvis/bin/playlist.bat';
	  var Txt = new Array; 
			Txt[0] = "Je le fai de suite meussieur.";
			Txt[1] = "Très bien, c'est comme si c'était fait.";
			Txt[2] = "Bonne écoute , ou bon visionnage.";
			Txt[3] = "D'accord";
			Txt[4] = "J'ouvre votre playlist tou de suite.";
	  break;
	  ...
	  break;
	  case "next":
	  process = '%CD%/plugins/jarvis/bin/droite.vbs';
	  var Txt = new Array; 
			Txt[0] = "suivant";
	  break;
	  case "precedent":
	  process = '%CD%/plugins/jarvis/bin/gauche.vbs';
	  var Txt = new Array; 
